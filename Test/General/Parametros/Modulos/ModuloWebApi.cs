    ...
    public class ModuloWebApi
    {
        ...
        public async Task Get()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    httpmensaje.RequestUri = new Uri(apiUrls.GetUrl("ModuloWebApi"));
        ...
        public async Task Post()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "0" },
                    { "values", "{\"Nombre\":\"Post\",\"Estaactivo\":false,\"Escartera\":false,\"Escontabilidad\":false}" }
                };
                var content = new FormUrlEncodedContent(data);
                var request = new HttpRequestMessage
                {
                    RequestUri = new Uri(apiUrls.GetUrl("ModuloWebApi")),//aqui cambias la direccion
        ...
        public async Task Put()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "8" },
                    { "values", "{\"Nombre\":\"put\",\"Estaactivo\":false,\"Escartera\":false,\"Escontabilidad\":false}" }
