...
namespace SiianTest.Test.General.Parametros.Modena
{
    [TestClass]
    public class MonedaWebApi
    {
        ...
        public async Task Get()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    httpmensaje.RequestUri = new Uri(apiUrls.GetUrl("MonedaWebApi"));
        ...
        public async Task Post()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "0" },
                    { "values", "{\"Sigla\":\"Pos\",\"Nombre\":\"post\",\"Simbolo\":\"$\",\"Esactivo\":false}" }
                };
                var content = new FormUrlEncodedContent(data);
                var request = new HttpRequestMessage
                {
                    RequestUri = new Uri(apiUrls.GetUrl("MonedaWebApi")),//aqui cambias la direccion
        ...
        public async Task Put()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "4" },
                    { "values", "{\"Id\":4,\"Sigla\":\"Put\",\"Nombre\":\"put\",\"Simbolo\":\"X\",\"Esactivo\":false}" }
        ...
        public async Task Delete()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                using (HttpResponseMessage mensaje = response)
                {
                    ...
                    RestResponse restResponse = new RestResponse((int)statusCode, responseData);
                    Console.WriteLine(restResponse);
                    Console.WriteLine("esta api no soporta el metodo delete");
