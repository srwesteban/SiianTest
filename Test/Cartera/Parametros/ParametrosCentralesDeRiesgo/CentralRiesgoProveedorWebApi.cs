...
{
    [TestClass]
    public class CentralRiesgoProveedorWebApi
    {
        [TestMethod]
        public async Task Get()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    httpmensaje.RequestUri = new Uri(apiUrls.GetUrl("CentralRiesgoProveedorWebApi"));
        ...
        public async Task Post()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "0" },
                    { "values", "{\"Nombre\":\"Post\",\"Usuario\":null,\"Password\":null,\"Esactivo\":false}"}
                };
                var content = new FormUrlEncodedContent(data);
                var request = new HttpRequestMessage
                {
                    RequestUri = new Uri(apiUrls.GetUrl("CentralRiesgoProveedorWebApi")),//aqui cambias la direccion
        ...
        public async Task Put()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "4" },
                    { "values", "{\"Nombre\":\"Put\",\"Usuario\":null,\"Password\":null,\"Esactivo\":false}"}
