...
{
    [TestClass]
    public class FrecuenciasPagoWebApi
    {
        [TestMethod]
        public async Task Get()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    httpmensaje.RequestUri = new Uri(apiUrls.GetUrl("FrecuenciasPagoWebApi"));
        ...
        public async Task Post()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "0" },
                    { "values", "{\"Dias\":0,\"Nombre\":\"Post\",\"Codigo\":\"abc\"}"}
                };
                var content = new FormUrlEncodedContent(data);
                var request = new HttpRequestMessage
                {
                    RequestUri = new Uri(apiUrls.GetUrl("FrecuenciasPagoWebApi")),//aqui cambias la direccion
        ...
        public async Task Put()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    { "key", "12" },
                    { "values", "{\"Dias\":0,\"Nombre\":\"Put\",\"Codigo\":\"abc\"}"}
