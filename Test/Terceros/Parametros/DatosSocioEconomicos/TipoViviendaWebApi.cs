...
{
    [TestClass]
    public class TipoViviendaWebApi
    {
        [TestMethod]
        public async Task Get()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                using (HttpRequestMessage httpmensaje = new HttpRequestMessage())
                {
                    ...
                    httpmensaje.RequestUri = new Uri(apiUrls.GetUrl("TipoViviendaWebApi"));
        ...
        public async Task Put()
        {
            ...
            using (HttpClient cliente = new HttpClient())
            {
                ...
                {
                    RequestUri = new Uri(apiUrls.GetUrl("TipoViviendaWebApi")),//aqui cambias la direccion
